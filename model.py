...
class DecoderLayer(torch.nn.Module):
    """
    Pytorch module for an decoder layer.
...
class LanguageModel(torch.nn.Module):
    ...
    def __init__(
        ...
        if feed_forward_dimension is None:
            # Chinchilla paper uses 4 * embedding_dimension for the feed forward dimension
...
if __name__ == "__main__":
    ...
    loss_per_epoch = trainer.train(sequences, epochs=1, batch_size=1)
    ...
    generated_text = generator.generate(
        ...
        prompt="i have a story to tell you",
